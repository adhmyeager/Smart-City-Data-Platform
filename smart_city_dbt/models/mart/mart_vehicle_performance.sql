...
SELECT
    ...
    ROUND(f.total_fuel_consumed_l * {{ var('fuel_price_egp') }}, 3) AS fuel_cost_egp,
    ...
    ROUND(f.total_fuel_consumed_l * {{ var('co2_kg_per_litre') }}, 5) AS co2_kg
